...
const buttonStyles = {
  approve:
    "bg-emerald-200 text-emerald-700 hover:bg-emerald-300 focus:ring-emerald-400",
                  ...
                  >
                    <div className="flex items-center justify-between">
                          ...
                          <img
                            src={
                              request.product.images[0]?.url
                                ? getImageUrl(request.product.images[0].url)
                            ...
                            onError={(e) => {
                              ...
                              console.error("Image load error:", {
                                ...
                                originalUrl: request.product.images[0]?.url,
                      ...
                      <div className="ml-4 flex flex-shrink-0 space-x-2">
                        <button
                          onClick={() =>
                            handleRentalAction(request._id, "approve")
                          }
                        ...
                        <button
                          onClick={() =>
                            handleRentalAction(request._id, "reject")
                          }
