...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    ...(user?.role === 'vendor' ? [
      { name: 'My Products', href: '/vendor/products', current: location.pathname === '/vendor/products' },
      { name: 'My Rentals', href: '/vendor/rentals', current: location.pathname === '/vendor/rentals' }
    ] : []),
    ...(user?.role === 'customer' ? [
      { name: 'My Rentals', href: '/customer/rentals', current: location.pathname === '/customer/rentals' }
    ] : [])
  ];
