...
router.get('/', async (req, res) => {
  try {
    ...
    if (maxPrice) query['pricing.perDay'] = { ...query['pricing.perDay'], $lte: Number(maxPrice) };
    if (search) {
...
router.get('/:id/availability', async (req, res) => {
  try {
    ...
    const isAvailable = product.isAvailableForDates(new Date(startDate), new Date(endDate));
